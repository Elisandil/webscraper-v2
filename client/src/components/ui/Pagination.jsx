        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-gray-800/90 border border-white/20 text-white text-sm rounded-md px-3 py-1 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent"
            >
